...
func main() {
	...
	bus.Subscribe(UserRegistered, auditLogProcessor)
	bus.Subscribe(UserRegistered, metricsProcessor)

	bus.Subscribe(UserLoggedIn, emailNotificationProcessor)
	bus.Subscribe(UserLoggedIn, auditLogProcessor)
	bus.Subscribe(UserLoggedIn, metricsProcessor)
	bus.Subscribe(UserLoggedIn, securityProcessor)

	bus.Subscribe(PasswordChanged, emailNotificationProcessor)
	bus.Subscribe(PasswordChanged, auditLogProcessor)
