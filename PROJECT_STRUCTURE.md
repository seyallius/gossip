...
- `EventProcessor` - Processor function signature
...
- `Middleware` - Processor wrapper type
...
- `NewFilteredProcessor()` - Conditional handler
...
- `BatchProcessor` - Batch handler function type
- `BatchConfig` - Batch configuration
- `NewBatchProcessor()` - Create processor
- `AsEventProcessor()` - Convert to event handler
